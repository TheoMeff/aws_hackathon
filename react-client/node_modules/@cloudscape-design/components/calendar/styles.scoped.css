...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_calendar_1ykar_1pugm_153:not(#\9) {
  animation: awsui_awsui-motion-fade-in-0_1ykar_1pugm_1 var(--motion-duration-show-quick-tyvnyw, 135ms) var(--motion-easing-show-quick-9hlj8q, ease-out);
  animation-fill-mode: both;
}
@keyframes awsui_awsui-motion-fade-in-0_1ykar_1pugm_1 {
  from {
    opacity: 0;
  }
  to {
...
.awsui-motion-disabled .awsui_calendar_1ykar_1pugm_153:not(#\9), .awsui-mode-entering .awsui_calendar_1ykar_1pugm_153:not(#\9) {
  animation: none;
  transition: none;
}
...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_root_1ykar_1pugm_180:not(#\9) {
  /* used in test-utils */
}
...
.awsui_calendar-inner_1ykar_1pugm_218:not(#\9) {
  margin-block: var(--space-xs-ymlm0b, 8px);
  margin-inline: var(--space-xs-ymlm0b, 8px);
}
.awsui_calendar-header_1ykar_1pugm_222:not(#\9) {
  display: flex;
  justify-content: space-between;
  align-items: center;
}
.awsui_calendar-header-title_1ykar_1pugm_227:not(#\9) {
  font-size: var(--font-size-body-m-a7nh2n, 14px);
  line-height: var(--line-height-body-m-2mh3ke, 20px);
  font-weight: 700;
...
.awsui_calendar-next-btn_1ykar_1pugm_235:not(#\9) {
  /* used for identifying element */
}
.awsui_calendar-prev-btn_1ykar_1pugm_238:not(#\9) {
  /* used for identifying element */
}
.awsui_calendar-grid_1ykar_1pugm_241:not(#\9) {
  inline-size: 100%;
  table-layout: fixed;
}
.awsui_calendar-grid_1ykar_1pugm_241:not(#\9):not(.awsui_calendar-grid-dense_1ykar_1pugm_245) {
...
.awsui_calendar-grid-dense_1ykar_1pugm_245:not(#\9) {
  border-spacing: 0;
}
.awsui_calendar-grid-cell_1ykar_1pugm_253:not(#\9) {
  word-break: break-word;
  text-align: center;
  font-weight: unset;
}
.awsui_calendar-date-header_1ykar_1pugm_258:not(#\9) {
...
.awsui_calendar-date_1ykar_1pugm_258:not(#\9) {
...
.awsui_calendar-date_1ykar_1pugm_258:not(#\9):first-child {
  border-inline-start: 1px solid var(--color-border-calendar-grid-67r4w4, transparent);
}
.awsui_calendar-date-enabled_1ykar_1pugm_278:not(#\9) {
  cursor: pointer;
  color: var(--color-text-dropdown-item-secondary-77b2z6, #656871);
}
.awsui_calendar-date-enabled_1ykar_1pugm_278:not(#\9)::after {
...
.awsui_calendar-date-enabled_1ykar_1pugm_278.awsui_calendar-date-current-page_1ykar_1pugm_288:not(#\9) {
  color: var(--color-text-dropdown-item-default-zani00, #0f141a);
}
.awsui_calendar-date-enabled_1ykar_1pugm_278.awsui_calendar-date-current-page_1ykar_1pugm_288:not(#\9):hover {
  border-start-start-radius: var(--border-radius-item-iwaia5, 8px);
  border-start-end-radius: var(--border-radius-item-iwaia5, 8px);
  border-end-start-radius: var(--border-radius-item-iwaia5, 8px);
  border-end-end-radius: var(--border-radius-item-iwaia5, 8px);
...
.awsui_calendar-date-enabled_1ykar_1pugm_278.awsui_calendar-date-current-page_1ykar_1pugm_288:not(#\9):hover:not(.awsui_calendar-date-selected_1ykar_1pugm_299)::after {
...
.awsui_calendar-date-current_1ykar_1pugm_288:not(#\9) {
  border-start-start-radius: var(--border-radius-item-iwaia5, 8px);
  border-start-end-radius: var(--border-radius-item-iwaia5, 8px);
  border-end-start-radius: var(--border-radius-item-iwaia5, 8px);
  border-end-end-radius: var(--border-radius-item-iwaia5, 8px);
...
.awsui_calendar-date_1ykar_1pugm_258:not(#\9)::after {
  content: "";
  position: absolute;
  z-index: 1;
...
.awsui_calendar-date_1ykar_1pugm_258:not(#\9):not(.awsui_calendar-date-dense_1ykar_1pugm_320)::after {
  inset-block-end: calc(-1 * var(--border-item-width-miijiw, 2px));
  inset-inline-start: calc(-1 * var(--border-item-width-miijiw, 2px));
}
.awsui_calendar-date-dense_1ykar_1pugm_320:not(#\9)::after {
  inset-block-end: -1px;
  inset-inline-start: -1px;
}
.awsui_calendar-date_1ykar_1pugm_258 > .awsui_date-inner_1ykar_1pugm_328:not(#\9) {
  position: relative;
  z-index: 1;
}
.awsui_calendar-date_1ykar_1pugm_258:not(#\9):focus {
  outline: none;
}
body[data-awsui-focus-visible=true] .awsui_calendar-date_1ykar_1pugm_258:not(#\9):focus:focus {
  position: relative;
}
body[data-awsui-focus-visible=true] .awsui_calendar-date_1ykar_1pugm_258:not(#\9):focus:focus {
...
body[data-awsui-focus-visible=true] .awsui_calendar-date_1ykar_1pugm_258:not(#\9):focus:focus::before {
  content: " ";
  display: block;
  position: absolute;
...
.awsui_calendar-date-selected_1ykar_1pugm_299:not(#\9) {
  border-color: transparent;
  position: relative;
  z-index: 2;
  font-weight: 700;
}
body[data-awsui-focus-visible=true] .awsui_calendar-date-selected_1ykar_1pugm_299:not(#\9):focus:focus {
  position: relative;
}
body[data-awsui-focus-visible=true] .awsui_calendar-date-selected_1ykar_1pugm_299:not(#\9):focus:focus {
  outline: 2px dotted transparent;
...
body[data-awsui-focus-visible=true] .awsui_calendar-date-selected_1ykar_1pugm_299:not(#\9):focus:focus::before {
  content: " ";
  display: block;
  position: absolute;
  inset-inline-start: calc(-1 * var(--space-calendar-grid-focus-outline-gutter-vvh43m, -5px));
...
.awsui_calendar-date-selected_1ykar_1pugm_299:not(#\9)::after {
  border-start-start-radius: var(--border-radius-item-iwaia5, 8px);
  border-start-end-radius: var(--border-radius-item-iwaia5, 8px);
  border-end-start-radius: var(--border-radius-item-iwaia5, 8px);
  border-end-end-radius: var(--border-radius-item-iwaia5, 8px);
...
.awsui_calendar-date-selected_1ykar_1pugm_299 > .awsui_date-inner_1ykar_1pugm_328:not(#\9) {
  z-index: 2;
  color: var(--color-background-control-default-nub6gm, #ffffff);
  position: relative;
}
.awsui_calendar-row_1ykar_1pugm_403:not(#\9):first-child > .awsui_calendar-date_1ykar_1pugm_258 {
  border-block-start: 1px solid var(--color-border-calendar-grid-67r4w4, transparent);
}

.awsui_disabled-reason-tooltip_1ykar_1pugm_407:not(#\9) {
