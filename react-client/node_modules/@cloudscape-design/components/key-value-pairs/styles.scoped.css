...
.awsui_key-value-pairs_1y9fy_108ba_145:not(#\9) {
...
.awsui_group-title_1y9fy_108ba_177:not(#\9) {
  padding-block-end: var(--space-scaled-m-m892r9, 16px);
}

.awsui_group-list_1y9fy_108ba_181:not(#\9) {
...
.awsui_group-list-item_1y9fy_108ba_191:not(#\9) {
  /* used in test-utils */
}

.awsui_term_1y9fy_108ba_195:not(#\9) {
  font-size: var(--font-size-body-m-a7nh2n, 14px);
  line-height: var(--line-height-body-m-2mh3ke, 20px);
...
.awsui_key-label_1y9fy_108ba_203:not(#\9) {
  display: inline-flex;
  margin-inline-end: var(--space-xs-ymlm0b, 8px);
}
.awsui_key-label_1y9fy_108ba_203:not(#\9):only-child {
  margin-block: 0;
  margin-inline: 0;
}

.awsui_detail_1y9fy_108ba_212:not(#\9) {
  border-collapse: separate;
  border-spacing: 0;
  box-sizing: border-box;
  caption-side: top;
...
.awsui_info_1y9fy_108ba_247:not(#\9) {
  display: inline-flex;
