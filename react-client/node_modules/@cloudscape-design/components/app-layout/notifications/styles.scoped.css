...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_notifications_1hmm4_1d3vc_9:not(#\9),
.awsui_notifications-sticky_1hmm4_1d3vc_10:not(#\9) {
  z-index: 850;
}
...
.awsui_no-content-paddings_1hmm4_1d3vc_25:not(#\9) {
  /*
   ...
   */
  --awsui-stacked-notifications-bottom-margin-xgujsu: var(--space-scaled-l-sej05l, 20px);
}