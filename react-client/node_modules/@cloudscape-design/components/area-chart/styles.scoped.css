...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_series_y1yrh_msafq_189 > rect:not(#\9) {
...
.awsui-motion-disabled .awsui_series_y1yrh_msafq_189 > rect:not(#\9), .awsui-mode-entering .awsui_series_y1yrh_msafq_189 > rect:not(#\9) {
  animation: none;
  transition: none;
}

.awsui_root_y1yrh_msafq_203:not(#\9) {
  /* used in test-utils */
}

.awsui_series_y1yrh_msafq_189:not(#\9) {
  display: block;
...
.awsui_series--highlighted_y1yrh_msafq_215:not(#\9) {
  /* used in test-utils */
}

.awsui_series--dimmed_y1yrh_msafq_219:not(#\9) {
  opacity: 0.3;
}

.awsui_series--threshold_y1yrh_msafq_223:not(#\9) {
  stroke-dasharray: var(--border-line-chart-dash-array-desefi, 3 5);
  stroke-width: var(--border-line-chart-width-tesor1, 2px);
}

.awsui_popover-divider_y1yrh_msafq_228:not(#\9) {
